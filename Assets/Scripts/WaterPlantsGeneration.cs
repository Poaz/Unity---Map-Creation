...
public class WaterPlantsGeneration : Singleton<WaterPlantsGeneration>
{
    ...
    Color[,] image;
    private bool first;
    Color ColorWeAreLookingFor = new Color(110f / 255, 150f / 255, 210f / 255);
    ...
    public void CallGenerateWaterPlants()
    {
        GenerateWaterPlants();
    }

    public void GenerateWaterPlants()
    {
